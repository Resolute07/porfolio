...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-5">
      Hi, I'm Utkarsh, a seasoned freelancer and a final-year undergraduate at Sir M. Visvesvaraya Institute of Technology with a passion for Mobile App development. Currently, I'm a <span className="font-bold">SDE Intern</span>  at GridxEnergy, where I enjoy tackling complex problems and bringing ideas to life. My core stack includes <span className="italic">Flutter, Djnago, Firebase,</span> and <span className="italic">Postgress SQL</span> , with additional expertise in Django Rest Framework, Java, Google cloud , and AWS. I've successfully completed <span className="font-bold">more than 5 freelance projects</span>
      </p>
      <p>
