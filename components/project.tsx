      ...
      <section className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[26rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          ...
          <div className="flex flex-row justify-center gap-x-4 mt-8">
            <a href={visitURL} className={`${!visitURL ? 'hidden' : ''}`}>

              <button className="flex flex-row bg-black/[0.7] px-3 py-1 text-[0.9rem]  tracking-wider text-white rounded-full dark:text-white/80">
                Visit <RiShareBoxLine className="mt-1 ml-1" />
              </button>
